...
const Login = () => {
  ...
  const inpStyles =
    "border-b-[2px] w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-transparent";
  ...
  useEffect(() => {
    const pseudoFetch = fetch(import.meta.env.VITE_REACT_APP_BACKEND_URL);
  ...
  return (
    <form
      className="flex flex-col items-center justify-around bg-[#FEFEFF] bg-opacity-15 shadow-md rounded-3xl p-8 w-[400px] aspect-[586/728]"
    ...
    >
      ...
      <div className="my-6 w-full relative">
        ...
        {!showPassword ? (
          <svg
            ...
            id="eye"
            fill="#ffffff"
            className="cursor-pointer absolute size-6 right-0 top-1/2 -translate-y-1/2"
      ...
      <div className="flex flex-col items-center justify-between gap-3">
        ...
        >
          ...
          <Link to="/signup" className="text-blue-500 mx-2">
            Signup
          </Link>
        </button>
      </div>
