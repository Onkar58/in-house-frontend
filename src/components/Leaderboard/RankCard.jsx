...
const RankCard = ({ data, position }) => {
  return (
    <div className={`text-black ${position === 1 ? "sm:order-2 scale-110" : position === 2 ? "sm:order-1 scale-100" : "sm:order-3 scale-90"} bg-[#ffffff52] shadow-[2px_2px_5px_#ffffff42] p-5 aspect-[4/5] h-[220px] rounded-md`} >
      <div className=''>
