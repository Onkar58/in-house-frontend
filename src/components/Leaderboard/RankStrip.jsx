    ...
    return (
        <div className='w-full bg-[#ffffff42] flex items-center justify-between px-5 py-2 rounded-md text-center text-sm text-opacity-70' >
            ...
            <svg width="8" height="18" viewBox="0 0 8 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M1.42842 17.3334C1.10483 17.3334 0.781232 17.1701 0.534744 16.8451C0.0405021 16.1934 0.0405021 15.1401 0.534744 14.4884L4.71241 8.98009L0.692749 3.49176C0.20862 2.82842 0.222525 1.77342 0.72435 1.13509C1.22744 0.496756 2.02758 0.515089 2.51171 1.17509L7.39345 7.84176C7.87252 8.49676 7.8662 9.53509 7.37828 10.1784L2.3221 16.8451C2.07561 17.1701 1.75202 17.3334 1.42842 17.3334" fill="black" />
            </svg>
