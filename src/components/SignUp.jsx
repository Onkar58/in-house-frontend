...
const SignUp = () => {
    ...
    const [formData, setFormData] = useState({ name: '', email: '', password: '' , profilePic: defaultImg});
    ...
    return (
        <div className="flex justify-center items-center h-screen text-white">
            <form className="flex flex-col items-center justify-around bg-[#FEFEFF] bg-opacity-15 shadow-md rounded-3xl p-8 w-[400px] aspect-[586/728]" onSubmit={handleSubmit}>
                <h1 className='text-3xl font-[600] my-10'>Get Started</h1>
                <div className="mb-4 w-full relative">
                    <label className="block text-sm font-bold" htmlFor="profilePic">
                        Profile Pic
                    </label>
                    <input
                        name='profilePic'
                        ...
                        ref={imgRef}
                    />
                    <img src={formData.profilePic} title='Click to Change Image' className='h-[150px] bg-red-400 rounded-lg mx-auto hover:opacity-50' onClick={() => imgRef.current.click()}/>
                </div>
